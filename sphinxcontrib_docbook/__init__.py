...
class DocbookVisitor(NodeVisitor):
    ...
    def visit_document(self, node):
        ...
        self.generator.outf.write('''<!DOCTYPE chapter PUBLIC "-//OASIS//DTD DocBook XML V4.5//EN" "http://www.oasis-open.org/docbook/xml/4.5/docbookx.dtd">''')
        self.sec_level = 0
    ...
    def visit_section(self, node):
        ...
        self.generator.startElement('chapter' if self.sec_level == 0 else 'section', {})
        self.sec_level += 1

    def depart_section(self, node):
        self.sec_level -= 1
        self.generator.endElement('chapter' if self.sec_level == 0 else 'section')
...
class DocbookXMLBuilder(Builder):
    ...
    def finish(self):
        with open(os.path.join(self.outdir,
            ...
            f.write('''<!DOCTYPE book PUBLIC "-//OASIS//DTD DocBook XML V4.5//EN" "http://www.oasis-open.org/docbook/xml/4.5/docbookx.dtd">''')
            f.write('<book>\n')
