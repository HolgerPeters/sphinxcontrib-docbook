...
project = u'sphinxcontrib-docbook'
copyright = u'2015, Holger Peters'
...
htmlhelp_basename = 'sphinxcontrib_docbook-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'sphinxcontrib-docbook Documentation',
   u'Holger Peters', 'manual'),
]
